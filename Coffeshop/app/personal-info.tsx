          ...
          <View style={styles.horizontalRow}>
            <View style={styles.flexHalf}>
              ...
              <Controller control={control} name="password" render={({ field: { onChange, value } }) => (
                <View style={styles.fieldWrapper}>
                  <TextInput style={[styles.inputBox, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.password)]} value={value} onChangeText={onChange} secureTextEntry />
            ...
            <View style={styles.flexHalf}>
              ...
              <Controller control={control} name="confirmPassword" render={({ field: { onChange, value } }) => (
                <View style={styles.fieldWrapper}>
                  <TextInput style={[styles.inputBox, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.confirmPassword)]} value={value} onChangeText={onChange} secureTextEntry />
