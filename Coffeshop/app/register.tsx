      ...
      <View style={styles.screenContainer}>
        ...
        <Controller control={control} name="email" render={({ field: { onChange, value } }) => (
          <View style={styles.inputWrapper}>
            <TextInput 
              style={[styles.textInput, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.email)]} 
              placeholder="Email" 
        ...
        <Controller control={control} name="password" render={({ field: { onChange, value } }) => (
          <View style={styles.inputWrapper}>
            <View style={[styles.passwordContainer, { backgroundColor: theme.card }, getBorderStyle(errors.password)]}>
              <TextInput 
        ...
        <Controller control={control} name="confirmPassword" render={({ field: { onChange, value } }) => (
          <View style={styles.inputWrapper}>
             <View style={[styles.passwordContainer, { backgroundColor: theme.card }, getBorderStyle(errors.confirmPassword)]}>
              <TextInput 
                style={[styles.flexInput, { color: theme.text }]} 
              ...
              <Pressable onPress={() => setShowConfirmPassword(!showConfirmPassword)} style={styles.eyeIcon}>
                <Ionicons name={showConfirmPassword ? "eye-off" : "eye"} size={22} color={theme.textMuted} />
              </Pressable>
            </View>
        ...
        <Controller control={control} name="name" render={({ field: { onChange, value } }) => (
          <View style={styles.inputWrapper}>
            <TextInput 
              style={[styles.textInput, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.name)]} 
        ...
        <View style={styles.inputWrapper}>
          <View style={styles.phoneContainer}>
            ...
            <Controller control={control} name="phone" render={({ field: { onChange, value } }) => (
              <TextInput 
                style={[styles.textInput, { backgroundColor: theme.card, color: theme.text, flex: 1 }, getBorderStyle(errors.phone)]} 
        ...
        <Controller control={control} name="street" render={({ field: { onChange, value } }) => (
          <View style={styles.inputWrapper}>
            <TextInput 
              style={[styles.textInput, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.street)]} 
        ...
        <View style={styles.horizontalRow}>
          <View style={[styles.inputWrapper, { flex: 1.5 }]}>
            <Controller control={control} name="town" render={({ field: { onChange, value } }) => (
              <View>
                <TextInput 
                  style={[styles.textInput, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.town)]} 
                  placeholder="City" 
                  placeholderTextColor={theme.textMuted} 
                  value={value} 
                  onChangeText={(text) => onChange(text.replace(/[^a-zA-Z\s]/g, ""))} 
          ...
          <View style={[styles.inputWrapper, { flex: 1 }]}>
            <Controller control={control} name="zip" render={({ field: { onChange, value } }) => (
              <View>
                <TextInput 
                  style={[styles.textInput, { backgroundColor: theme.card, color: theme.text }, getBorderStyle(errors.zip)]} 
                  placeholder="ZIP" 
                  placeholderTextColor={theme.textMuted} 
                  value={value} 
