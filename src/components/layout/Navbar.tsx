...
import { Menu, X, Scale, User, Plus, Home, Grid3X3, LogIn, LogOut, Truck, TrendingUp, Armchair } from 'lucide-react';
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass-effect">
      <div className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
         ...
         <div className="w-10 h-10 rounded-lg bg-sidebar-primary flex items-center justify-center bg-gradient-to-tr from-primary to-secondary">
            <Armchair className="w-6 h-6 text-sidebar-primary-foreground" />
          </div>
